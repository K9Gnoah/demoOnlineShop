...
<section class="ftco-section ftco-no-pb ftco-no-pt bg-light">
    <div class="container">
        <div class="row">
            <div class="col-md-5 p-md-5 img img-2 d-flex justify-content-center align-items-center" style="background-image: url('<c:url value="/template/homepage/images/about.jpg"/>')">
            ...
            <div class="col-md-7 py-5 wrap-about pb-md-5 ftco-animate">
                ...
                <div class="pb-md-5">
                    ...
                    <p><a href="/customer/showProduct" class="btn btn-primary">Shop now</a></p>
                </div>
            </div>
        </div>
    </div>
...
<section class="ftco-section ftco-counter img" id="section-counter" style="background-image: url('<c:url value="/template/homepage/images/bg_3.jpg"/>')">
    <div class="container">
