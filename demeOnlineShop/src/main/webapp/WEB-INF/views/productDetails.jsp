        ...
        <div class="col-md-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="card-text">Left in stock: ${product.productQuantity}</p>
                    <h6 class="text-muted">Price: ${product.productPrice}VND</h6>
                    <!-- Add to Cart Button -->
                    <button class="btn btn-primary add-to-cart-button" data-product-id="${product.productId}">Add to Cart</button>
                </div>
            </div>
        </div>
    </div>
