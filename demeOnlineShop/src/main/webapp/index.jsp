...
<section id="home-section" class="hero">
    <div class="home-slider owl-carousel">
        <div class="slider-item" style="background-image: url('<c:url value="/template/homepage/images/bg_1.jpg"/>')">
        ...
        <div class="slider-item" style="background-image: url('<c:url value="/template/homepage/images/bg_2.jpg"/>')">
            <div class="overlay"></div>
            <div class="container">
                <div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">
...
<section class="ftco-section img" style="background-image: url('<c:url value="/template/homepage/images/bg_3.jpg"/>')">
    <div class="container">
